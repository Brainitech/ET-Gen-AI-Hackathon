...
.news-card:hover {
    ...
    box-shadow: 0 4px 24px rgba(139,0,0,0.18), inset 0 0 0 1px rgba(178,34,34,0.1);
...
/* Streamlit expander styling for sidebar */
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    for col, (icon, name, desc) in zip([col1, col2, col3, col4], features):
        with col:
            ...
            <div class="glass-card" style="text-align:center; padding:2rem 1.5rem;">
                ...
                <div style="font-family:'Playfair Display',serif; font-size:1.05rem; font-weight:700; color:#fff; margin-bottom:0.5rem;">{name}</div>
    ...
    <div class="glass-card" style="margin-top:1rem;">
        ...
        <div style="color:#888; font-size:0.88rem; line-height:2.2;">
            <b style="color:#e8e0d5;">1.</b> Start Ollama: <code style="color:#B22222; background:rgba(139,0,0,0.1); padding:2px 8px; border-radius:4px;">ollama run llama3.1:8b</code><br/>
            <b style="color:#e8e0d5;">2.</b> Start the backend: <code style="color:#B22222; background:rgba(139,0,0,0.1); padding:2px 8px; border-radius:4px;">uvicorn app.main:app --reload</code><br/>
            <b style="color:#e8e0d5;">3.</b> Use the sidebar to navigate →
        </div>
    </div>
    """, unsafe_allow_html=True)
